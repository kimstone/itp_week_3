...
print('Apple Cell Value [B1] = ' + apple_cell.value)

another_cell = my_sheet['B3']
print('Another Cell Value [B3] = ' + another_cell.value)
print('Row %s, Column %s is %s' %(another_cell.row, another_cell.column, another_cell.value))
print('COORDINATE/CELL %s is %s' %(another_cell.coordinate, another_cell.value))
